...
<div class="container-fluid" style="width: 90%; background-color: #444; margin-bottom:20px; padding-bottom:20px; box-shadow:rgba(0,0,0,0.3) 2px 4px 4px 4px">    
    <h2 style="text-align: center; padding-top:10px;">Our services</h2>
    <div class="service">
        ...
        <div class="modal fade" id="RTGS-modal" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3>RTGS/NEFT Services</h3>
                    </div>
        ...
        <div class="modal fade" id="deposit-modal" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3>Safe Deposit Locker Facility</h3>
                    </div>
    ...
    <div class="service">
        ...
        <div class="modal fade" id="ATM-modal" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3>ATM Services</h3>
                    ...
                    <div class="modal-body">
                        ...
                        <p>You can avail this facility, if you are having Savings, Current  account with us.<br>
                            ...
                            <li>By banking at the ATM, you save on time waiting for a teller.</li>
                            
                            <li>At the ATM, you don't need to worry about reaching before closing time of the Bank’s Branches and Banking holidays.</li>
                            
                            <li>When you bank at the ATM, you can make the most of its secure features like daily transaction limits and ATM receipts that help you keep track of your monies.</li>
                            
                            <li>You can withdraw up to Rs.25000/- per day from the ATM.<br>You don't need to rush to the bank next time you need some cash.</li>
                            
                            <li>You can use Rupay ATM Cum Debit card at <br>Now The Sarvodaya Sahakari Bank is member of NFS and Sarvodaya Bank's Rupay ATM Cum Debit Card can be operated at more than 2,20,000 ATMs  and more than 12,00,000 POS terminal.
                            </li><br>
                            
                            Customer can avail following services at  ATMs<br>
                            ...
                            <li>DTH Recharge*</li><br>
                            *Offered at Sarvodaya Bank's ATMs.</p>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table id="SMS-tab">
                            <tr>
                                <th>Type Message on Registered Mobile</th>
                                <th style=" text-align:center">Alert on Mobile</th>
                            </tr>
                            
                            <tr>
                                <td>B</td>
                                <td>For Accounts Balance</td>
                            </tr>
                            
                            <tr>
                                <td>M</td>
                                <td>For Last 5 Transactions of  your Accounts</td>
                            </tr>
                        </table>
                        <br>
                        <p>You can also get alerts for your day to day transactions on your registered mobile as per limit defined by the Bank.<br>This service is available to you absolutely FREE</p>
                    </div>
