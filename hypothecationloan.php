...
<html lang="en">
  ...
  <body>
    ...
    <?php
        include 'header.php';
    ?>
<div class="container-fluid" style="width: 90%; background-color: #444; margin-bottom:20px; box-shadow:rgba(0,0,0,0.3) 2px 4px 4px 4px">     <h2 style="text-align:center">Hypothecation Loan</h2>
    <div class="row">
    <div class="col-md-8">
        ...
        <ul style="text-align:justify;">
            ...
            <li>Loan maximum up to 60 % Valuation of the Stocks by the Bank’s approved valuer.</li>
            ...
            <li>Unmovable property required to be presented as Second Call Security </li>
            <li>Mortgage to be registered by  authority</li>
        </ul>
        <p ><strong>Primary Security :Mortgage of the Property offered.</strong></p>
        <p ><strong>Rate of Interest :</strong></p>
        <ul>
            <li>13.5 % (Less than ₹2,00,000)*. (Check again) </li>
    ...
    <ul class="main-menu">
      ...
      <li class="active"><a href="hypothecationloan.php">Hypothecation Loan</a></li>
