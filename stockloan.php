...
<html lang="en">
  ...
  <body>
    ...
    <?php
        include 'header.php';
    ?>
<div class="container-fluid" style="width: 90%; background-color: #444; margin-bottom:20px; box-shadow:rgba(0,0,0,0.3) 2px 4px 4px 4px">     <h2 style="text-align:center">Loan against Stock-in-trade</h2>
    <div class="row">
    <div class="col-md-8">
    ...
    <ul class="main-menu">
      ...
      <li class="active"><a href="stockloan.php">Loan against Stock-in-trade</a></li>
